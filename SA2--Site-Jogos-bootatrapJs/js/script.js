...
//função de telefone residencial
$(document).ready(function () {
    $("#telefone_res").blur(function () {
        var res = /^\([1-9]{2}\)[2-9]{1}[0-9]{3}\-[0-9]{4}$/;

        if (!res.test($("#telefone_res").val())) {
            if ($("#telefone_res").val() == '') {
                alert("O telefone residencial é obrigatorio, digite um numero valido");
            }else{
                alert("Telefone residencial invalido, insira um numero valido para prosseguir");
            }
        }else{
...
$(document).ready(function () {
    $("#telefone_cel").blur(function () {
        ...
        if (!cel.test($("#telefone_cel").val())) {
            if ($("#telefone_cel").val() == '') {
                alert("O telefone celular é obrigatorio, digite um numero valido");
            }else{
                alert("Telefone valido, insira um numero valido para proseguir");
            }
        }else{
